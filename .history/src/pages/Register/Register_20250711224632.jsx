...
import sticker from '../../assets/register-sticker.png'; // replace with your image path
...
const Register = () => {
  ...
  return (
    <motion.div
      className="min-h-screen flex flex-col md:flex-row items-center justify-center bg-gradient-to-br from-green-50 to-green-100 px-4"
    ...
    >
      ...
      <div className="w-full md:w-1/2 flex justify-center mb-6 md:mb-0">
        <img
          src={sticker}
          alt="Market Sticker"
          className="w-48 md:w-72 rounded-xl shadow-md"
        />
      </div>

      {/* Form Section */}
      <div className="max-w-md w-full bg-white p-8 rounded-2xl shadow-2xl border border-green-100">
