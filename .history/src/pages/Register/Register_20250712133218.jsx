  ...
  const onSubmit = data => {
    ...
    registerUser(email, password)
      .then(userCredential => {
        ...
        const profile = { displayName: name, photoURL: photo ? URL.createObjectURL(photo[0]) : null };
        return updateUserProfile(profile);
        // send user data to your server or database here
    ...
    //       // Here you can handle the registration logic with the uploaded image URL
    //     })
    //     .catch(error => {
